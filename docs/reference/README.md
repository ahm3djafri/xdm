...
* [Collaborator](./collaborator.schema.md) – `https://ns.adobe.com/collaboration/collaborator` (Unknown)
* [IMS User](./user.schema.md) – `https://ns.adobe.com/adobecloudplatform/ims/user` (Unknown)
